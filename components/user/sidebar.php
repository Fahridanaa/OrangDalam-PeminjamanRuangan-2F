      ...
      <ul>
        <li class="p-5 flex items-center justify-center">
          <a class="flex items-center justify-center rounded-md flex-col gap-4 group cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              class="w-6 h-6 fill-white group-hover:fill-fourth-color">
              <path
        ...
        <li class="p-5 flex items-center justify-center">
          <a class="flex items-center justify-center rounded-md flex-col gap-4 group group cursor-pointer">
            ...
            <span class="text-neutral-color group-hover:text-fourth-color">Pinjam</span>
          </a>
        ...
        <li class="p-5 flex items-center justify-center">
          <a class="flex items-center justify-center rounded-md flex-col gap-4 group group cursor-pointer">
            ...
            <span class="text-neutral-color group-hover:text-fourth-color">Inbox</span>
          </a>
        ...
        <li class="p-5 flex items-center justify-center">
          <a class="flex items-center justify-center rounded-md flex-col gap-4 group group cursor-pointer">
            ...
            <span class="text-neutral-color group-hover:text-fourth-color">History</span>
          </a>
