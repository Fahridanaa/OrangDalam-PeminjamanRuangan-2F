            ...
            <div class="flex border-2 border-[#7B7777] items-start p-5 rounded-xl gap-3 shadow-[0_4px_4px_0px_#00000025]">
                <div class="flex flex-auto justify-between">
                    <div class="flex flex-col gap-1">
                        ...
                        <span class="font-normal text-xl text-select-color">Berhasil</span>
                        <span class="hidden text-sm text-noFocus-color mt-3">Peminjaman kamu berhasil nih. Jangan lupa membersihkan ruangan setelah dipakai ya! :D</span>
                    </div>
                    <div>
