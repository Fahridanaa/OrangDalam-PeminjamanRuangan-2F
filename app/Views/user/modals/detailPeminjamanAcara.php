...
function renderModal(): string
{
    ...
    <div id="detail-peminjaman-acara-modal" class="modal hidden absolute inset-0">
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="animate-show-modal flex flex-col px-24 py-12 mx-auto bg-white border border-black animate-show-modal rounded-xl shadow-[0_4px_4px_0px_#00000025] z-20 opacity-0 -translate-y-5"
                 id="detailAcara">
                <div>
