        ...
        <div class="flex pl-16 justify-evenly md:flex-col">
            <div class="px-4">
                <div x-data="{ image: 1 }" class="flex flex-col gap-4">
                    <div class="flex">
                        <img src="/img/ruang/lt8/rt13/1.jpg" class="max-w-2xl rounded-xl md:w-full"
                             x-show="image === 1">
                        <img src="/img/ruang/lt8/rt13/2.jpg" class="max-w-2xl rounded-xl md:w-full"
                             x-show="image === 2">
                        <img src="/img/ruang/lt8/rt13/3.jpg" class="max-w-2xl rounded-xl md:w-full"
                             x-show="image === 3">
                    </div>
                    ...
                    <th colspan="6" class="rounded-t-xl text-start pt-1 px-3 focus:outline-none focus:shadow-none!">
                        <div class="relative flex items-center">
                            <input type="date" id="tanggalInput"
                                   class="w-10 text-sm bg-primary-color">
