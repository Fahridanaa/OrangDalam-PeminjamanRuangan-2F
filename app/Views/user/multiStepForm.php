        ...
        <div class="container mx-auto">
            <div class="w-11/12 lg:w-2/6 mx-auto">
                <div class="bg-gray-200 h-1 flex items-center justify-between">
                    <div class="w-1/3 bg-third-color h-1 flex items-center">
                        <div class="bg-third-color h-6 w-6 rounded-full shadow flex items-center justify-center">
                    ...
                    <div class="w-1/3 flex justify-between bg-third-color h-1 items-center relative">
                        ...
                        <div class="bg-third-color h-6 w-6 rounded-full shadow flex items-center justify-center -ml-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-check"
                                 width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FFFFFF"
                                 fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z"/>
                        ...
                        <div class="bg-white h-6 w-6 rounded-full shadow flex items-center justify-center -mr-3 relative">
                            <div class="h-3 w-3 bg-third-color rounded-full"></div>
                        </div>
                    </div>
