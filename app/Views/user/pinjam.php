            ...
            foreach ($data->showPinjam() as $item) :
                ...
                <div class="flex flex-col border-2 border-[#7B7777] items-start p-5 rounded-xl gap-4 shadow-[0_4px_4px_0px_#00000025]">
                    ...
                    <div class="self-end flex gap-5">
                        ...
                        <a href="/pinjam?id=<?php echo $item['id']?>" class="detail-acara-button ont-bold text-sm px-3 py-2 bg-third-color rounded-3xl text-neutral-color hover:bg-primary-color">
                            Detail
                            Peminjaman
                        </a>
                    </div>
