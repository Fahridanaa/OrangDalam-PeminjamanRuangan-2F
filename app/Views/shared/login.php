        ...
        <div class=" py-6 lg:w-full z-20 bg-neutral-color rounded-2xl flex gap-2 flex-col">
          ...
          <form action="" class="w-full ">
            <div class="pb-2 text-left">
              ...
              <input type="text" name="id" id="id" placeholder="Masukkan NIM/NIP..." class="block w-full p-4 text-lg rounded-xl text-text-color border border-fourth-color mt-2" />
            </div>
            <div class="pb-2 pt-4 text-left">
              <label class="text-text-color"> Password </label>
              <input class="block w-full p-4 text-lg rounded-xl text-text-color border border-fourth-color mt-2" type="password" name="password" id="password" placeholder="Masukkan Password..." />
            </div>
            <div class="pb-2 pt-4">
