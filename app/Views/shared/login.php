        ...
        <div class=" py-6 lg:w-full z-20 bg-neutral-color rounded-2xl flex gap-2 flex-col">
          ...
          <form method="POST" class="w-full ">
            ...
            <div class="pb-2 pt-4 text-left">
              ...
              <input class="block w-full p-4 text-lg rounded-xl text-text-color border border-fourth-color mt-2" type="password" name="password" id="password" placeholder="Masukkan Password..." required/>
            </div>
            <div class="pb-2 pt-4">
