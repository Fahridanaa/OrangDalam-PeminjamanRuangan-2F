...
function addUserRoutes()
{
    ...
    Router::add("POST", "/konfirmasi-ruangan", RequestController::class, "updateStatus");
    Router::add("GET", "/konfirmasi-ruangan/data", RequestController::class, "showDetailMatkul");
